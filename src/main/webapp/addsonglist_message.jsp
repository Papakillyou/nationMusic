...
<html lang="zh-cn">
<head>
    <meta http-equiv="Refresh" content="2;url=/nationMusic_war_exploded/songlist/songlist_showSongList?userId=${userid}">
    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>民族音乐系统</h1></div>
