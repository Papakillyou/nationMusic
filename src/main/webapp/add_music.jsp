...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x"  action="music_addMusic.action" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field l10" >
                    <input type="text" class="input w100" value="" name="music.title" data-validate="required:请输入内容" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field l10">
                    <input type="text" class="input w100" value="" name="music.singer" data-validate="required:请输入内容" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field l10">
                    <input type="text" class="input w50" value="" name="music.summary" data-validate="required:请输入内容" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field l10">
                    <input type="text" class="input w50" value="" name="music.nation" data-validate="required:请输入内容" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field l10">
                    <input type="file" value="" name="upmusic"  />
                    <div class="tips"></div>
                </div>
            </div>
